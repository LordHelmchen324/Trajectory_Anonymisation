...
class Anonymisation {
    ...
    public static void main(String[] args) {
        ...
        for (int k : ks) {
            ...
            Dataset.toJSON(result, "../Perfect Data Set/perfect_grid_1000_60_2000_2000_PROTECTED_sync_XmY_k" + k + ".json");
            Dataset.toCSV(result, "../Perfect Data Set/perfect_grid_1000_60_2000_2000_PROTECTED_sync_XmY_k" + k + ".csv");
        }
    }
