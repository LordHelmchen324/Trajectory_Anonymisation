...
class Anonymisation {
    ...
    public static void main(String[] args) {
        ...
        for (int k : ks) {
            ...
            Dataset.toJSON(d, "../Perfect Data Set/perfect_grid_1000_60_2000_2000_PROTECTED_k" + k + ".json");
            Dataset.toCSV(d, "../Perfect Data Set/perfect_grid_1000_60_2000_2000_PROTECTED_k" + k + ".csv");
        }
    }
